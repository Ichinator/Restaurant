...
$catalogue = new MessageCatalogue('sr_Cyrl', array (
  ...
  'FOSCommentBundle' => 
  array (
    'fos_comment_comment_new_headline_first' => 'Оставите први коментар',
    'fos_comment_comment_new_headline' => 'Додај нови коментар',
    ...
    'fos_comment_comment_show_by' => 'Коментар',
    'fos_comment_comment_show_voteup' => 'Гласај за',
    'fos_comment_comment_show_votedown' => 'Гласај против',
    'fos_comment_comment_show_reply' => 'Одговори',
    'fos_comment_comment_vote_score' => 'Гласова: ',
    'fos_comment_comment_tree_load_more' => 'Учитај још одговора',
    'fos_comment_rss_feed' => 'RSS канал',
    'fos_comment_thread_close' => 'Затвори дискусију',
    'fos_comment_thread_open' => 'Отвори дискусију',
    'fos_comment_thread_comment_count' => '%count% коментар|%count% коментара|%count% коментара',
    'fos_comment_comment_edit' => 'Измени',
    'fos_comment_comment_delete' => 'Обриши коментар',
    'fos_comment_comment_undelete' => 'Обнови коментар',
    'fos_comment_comment_deleted' => '[обрисано]',
  ),
));
