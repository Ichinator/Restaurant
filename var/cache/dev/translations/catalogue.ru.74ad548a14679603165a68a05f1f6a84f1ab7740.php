...
',
  ...
  'FOSCommentBundle' => 
  array (
    'fos_comment_comment_new_headline_first' => 'Оставьте первый комментарий',
    'fos_comment_comment_new_headline' => 'Добавить новый комментарий',
    ...
    'fos_comment_comment_show_by' => 'Комментарий от',
    'fos_comment_comment_show_voteup' => 'Голосовать за',
    'fos_comment_comment_show_votedown' => 'Голосовать против',
    'fos_comment_comment_show_reply' => 'Ответить',
    'fos_comment_comment_vote_score' => 'Голоса: ',
    'fos_comment_comment_tree_load_more' => 'Показать остальные ответы',
    'fos_comment_rss_feed' => 'Лента RSS',
    'fos_comment_thread_close' => 'Закрыть тред',
    'fos_comment_thread_open' => 'Открыть тред',
    ...
    'fos_comment_comment_undelete' => 'Восстановить комментарий',
